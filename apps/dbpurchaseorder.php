...
<body>
      ...
      <div class="wrapper wrapper-content animated fadeInRight">
        <div class="row">
          <div class="col-sm-12 m-b-xs">
            ...
            <a href="dbpoform.php" class="btn btn-info btn-sm"><span class="fa fa-plus-circle"></span> Tambah Order</a>
            <?php endif ?>
            <?php if($dt['level'] !== 'sales') : ?>
          ...
          <div class="col-lg-12">
            ...
            //$tglpo = $_POST['tgl_po'];
                ...
                <div class="table-responsive">
                  <table class="table tablePo table-bordered table-hover" data-page-navigation=".pagination" data-page-size="15" data-filter=#filter>
                    <thead scoop="row">
                      <tr>
                        <th>#</th>
                        <th>No. So</th>
                    ...
                    <tbody>
                      ...
                      $sql = $pdo->prepare("SELECT * FROM salesorder_hdr " . $where . "ORDER BY noso DESC");
                      ...
                      <tr>
                        ...
                        <td>
                          <?php
                            $sql2 = $pdo->prepare("SELECT DISTINCT(sales) FROM salesorder_hdr WHERE customer_id = '" . $data['customer_id'] . "'");
                            $sql2->execute();
                            while ($perusahaan = $sql2->fetch()) {
                                echo $perusahaan['sales'];
                            }
                          ?>
                        </td>
                        <td>
  ...
  <!--<script src="../js/plugins/footable/footable.paging.js"></script>-->
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content animated bounceInUp">
            ...
            <div class="modal-body">
                ...
                <form method="POST" action="exportcsv.php" id="formExport">
                    <div class="row">
                        <div class="col-sm-6">
