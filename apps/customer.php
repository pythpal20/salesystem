    ...
    $(document).ready(function(){
      var table = $('#memListTable').DataTable( {
        ...
        columnDefs:  [
        {
          "targets": -1,
          "data": null,
          "defaultContent": "<center><button class='btn btn-info btn-sm view_data' title='View Detail' rel='tooltip'><span class='fa fa-eye'></span></button> <button class='btn btn-primary btn-sm tblEdit' tooltip='Edit'><span class='fa fa-edit'></span> </button> <button class='btn btn-danger btn-sm tblDelete'><span class='fa fa-trash'></span> </button></center>" 
        }
        ]
      });
      // Penomoran 
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content animated bounceInUp">
            ...
            <div class="modal-body">
                <h5>Filter Export</h5>
                <form method="POST" action="exportcsvcustomer.php" id="formExport">
                    <div class="row">
                        <div class="col-sm-6">
